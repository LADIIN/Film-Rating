...
public class FilmDaoImpl extends AbstractDao<Film> {
    ...
    private static final String SELECT_BY_ID = "select films.id, films.title, film_types.type, genres.genre, films.year, films.director, countries.country, films.rating, films.is_deleted, films.poster_path\n" +
            "from films\n" +
            "join genres on genres.id = films.genre_id\n" +
            "join countries on countries.id = films.country_id\n" +
            "join film_types on film_types.id = films.type_id\n" +
    ...
    private static final String SELECT_GROUP = "select films.id, films.title, film_types.type, genres.genre, films.year, films.director, countries.country, films.rating, films.is_deleted, films.poster_path\n" +
            "from films\n" +
            "join genres on genres.id = films.genre_id\n" +
            "join countries on countries.id = films.country_id\n" +
            "join film_types on film_types.id = films.type_id\n" +
