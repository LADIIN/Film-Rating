    ...
    <div style="overflow-x:auto;">
        ...
        <table id="MyTable">
            <tr class="header">
                ...
                <th class="column" style="width:10%;"><fmt:message key="user.status" bundle="${content}"/></th>
                <th class="column" style="width:30%"><fmt:message key="user.block.status" bundle="${content}"/></th>
